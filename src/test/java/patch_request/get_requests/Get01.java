...
public class Get01 {
    ...
    3) Otomasyon testlerimizi yaparken asagidaki adimlari izliyoruz;
        ...
        b) Test case yaziyoruz
            i) Test Case yaziminda "Gherkin" dilini kullanacagiz..Biz yazilim diline hakim olsak da
            karsimizdaki kisiler hakim olmayabilir.
            Ama Gherkin ile yazilan tesleri anlamakta zorluk cekmeyeceklerdir.
            Gherkin dilinde kullanacagimiz keyword'ler:
            - Given : On kosullar,
            - When : Yapilacak aksiyonlar icin (get(), put(), post(), patch() ve delete() methodlari kullanacagiz
